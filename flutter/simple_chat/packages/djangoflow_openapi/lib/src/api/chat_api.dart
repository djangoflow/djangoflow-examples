...
class ChatApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ChatRoom] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ChatRoom>> chatRoomsCreate({ 
    ...
    try {
_bodyData=jsonEncode(chatRoomRequest);
    ...
    ChatRoom? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<ChatRoom, ChatRoom>(rawData, 'ChatRoom', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
...
_responseData = rawData == null ? null : deserialize<Object, Object>(rawData, 'Object', growable: true);
  ...
  Future<Response<PaginatedChatRoomList>> chatRoomsList({ 
    ...
    PaginatedChatRoomList? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<PaginatedChatRoomList, PaginatedChatRoomList>(rawData, 'PaginatedChatRoomList', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<PaginatedChatRoomList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ChatRoomMembers] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ChatRoomMembers>> chatRoomsMemberCreate({ 
    required String id,
    required ChatRoomMembersRequest chatRoomMembersRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/chat/rooms/{id}/member/'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
_bodyData=jsonEncode(chatRoomMembersRequest);
    } catch(error, stackTrace) {
      throw DioException(
         requestOptions: _options.compose(
          _dio.options,
    ...
    ChatRoomMembers? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<ChatRoomMembers, ChatRoomMembers>(rawData, 'ChatRoomMembers', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
...
_responseData = rawData == null ? null : deserialize<ChatRoomMemberList, ChatRoomMemberList>(rawData, 'ChatRoomMemberList', growable: true);
  ...
  Future<Response<ChatMessage>> chatRoomsMessagesCreate({ 
    ...
    final _path = r'/api/v1/chat/rooms/{room_id}/messages/'.replaceAll('{' r'room_id' '}', roomId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<ChatMessage, ChatMessage>(rawData, 'ChatMessage', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Object] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Object>> chatRoomsMessagesDestroy({ 
    required int id,
    required int roomId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/api/v1/chat/rooms/{room_id}/messages/{id}/'.replaceAll('{' r'id' '}', id.toString()).replaceAll('{' r'room_id' '}', roomId.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<Object, Object>(rawData, 'Object', growable: true);
  ...
  Future<Response<PaginatedChatMessageList>> chatRoomsMessagesList({ 
    ...
    PaginatedChatMessageList? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<PaginatedChatMessageList, PaginatedChatMessageList>(rawData, 'PaginatedChatMessageList', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<PaginatedChatMessageList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [ChatMessage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ChatMessage>> chatRoomsMessagesPartialUpdate({ 
    required int id,
    required int roomId,
    ...
    try {
_bodyData=jsonEncode(patchedChatMessageRequest);
    } catch(error, stackTrace) {
      throw DioException(
         requestOptions: _options.compose(
          _dio.options,
...
_responseData = rawData == null ? null : deserialize<ChatMessage, ChatMessage>(rawData, 'ChatMessage', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [ChatMessage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ChatMessage>> chatRoomsMessagesUpdate({ 
    required int id,
    required int roomId,
    required ChatMessageRequest chatMessageRequest,
    CancelToken? cancelToken,
...
_responseData = rawData == null ? null : deserialize<ChatMessage, ChatMessage>(rawData, 'ChatMessage', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [ChatRoom] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ChatRoom>> chatRoomsPartialUpdate({ 
    required String id,
    ...
    try {
_bodyData=jsonEncode(patchedChatRoomRequest);
    } catch(error, stackTrace) {
      throw DioException(
         requestOptions: _options.compose(
          _dio.options,
...
_responseData = rawData == null ? null : deserialize<ChatRoom, ChatRoom>(rawData, 'ChatRoom', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [ChatRoom] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ChatRoom>> chatRoomsRetrieve({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
...
_responseData = rawData == null ? null : deserialize<ChatRoom, ChatRoom>(rawData, 'ChatRoom', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [ChatRoom] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ChatRoom>> chatRoomsUpdate({ 
    required String id,
    required ChatRoomRequest chatRoomRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
