...
ReturnType deserialize<ReturnType, BaseType>(dynamic value, String targetType,
  ...
  switch (targetType) {
    ...
    case 'ChangeRequest':
      return ChangeRequest.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    case 'Connect':
      return Connect.fromJson(value as Map<String, dynamic>) as ReturnType;
    case 'ConnectRequest':
      return ConnectRequest.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    case 'Error':
    ...
    case 'SignupRequest':
      return SignupRequest.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    case 'SocialOAuth1TokenObtainProviderEnum':
    case 'SocialOAuth1TokenObtainRequest':
      return SocialOAuth1TokenObtainRequest.fromJson(
    ...
    case 'UnlinkRequest':
      return UnlinkRequest.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    default:
      RegExpMatch? match;
