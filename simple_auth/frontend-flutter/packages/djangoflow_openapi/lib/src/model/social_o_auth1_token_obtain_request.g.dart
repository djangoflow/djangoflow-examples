      ...
      ($checkedConvert) {
        ...
        final val = SocialOAuth1TokenObtainRequest(
          ...
          provider: $checkedConvert(
              'provider',
              (v) =>
                  $enumDecode(_$SocialOAuth1TokenObtainProviderEnumEnumMap, v)),
...
Map<String, dynamic> _$SocialOAuth1TokenObtainRequestToJson(
  ...
  val['provider'] =
      _$SocialOAuth1TokenObtainProviderEnumEnumMap[instance.provider]!;
  val['oauth_token'] = instance.oauthToken;
  val['oauth_token_secret'] = instance.oauthTokenSecret;
  return val;
}

const _$SocialOAuth1TokenObtainProviderEnumEnumMap = {
  SocialOAuth1TokenObtainProviderEnum.twitter: 'twitter',
};
