...
import 'package:openapi/src/model/patched_user_request.dart';
import 'package:openapi/src/model/user.dart';
import 'package:openapi/src/model/user_request.dart';
...
class AccountsApi {
  ...
  Future<Response<User>> accountsUsersPartialUpdate({ 
    required String id,
    ...
    final _path = r'/api/v1/accounts/users/{id}/'.replaceAll('{' r'id' '}', id.toString());
...
_responseData = rawData == null ? null : deserialize<User, User>(rawData, 'User', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [User] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<User>> accountsUsersRetrieve({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
...
_responseData = rawData == null ? null : deserialize<User, User>(rawData, 'User', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [User] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<User>> accountsUsersUpdate({ 
    required String id,
