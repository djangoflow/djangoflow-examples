...
void main() {
  ...
  group(ChatApi, () {
    ...
    //Future<Object> chatImagesDestroy(String id) async
    ...
    //Future<Object> chatRoomsDestroy(String id) async
    ...
    //Future<Object> chatRoomsUsersDestroy(String id, String roomPk) async
